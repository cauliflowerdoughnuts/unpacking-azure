...
![Bearer token obtained, User.Read.All and Mail.Read permissions](assets/images/2026-02-25-analyzing-the-midnight-blizzard-eviction-plan/token-pre-secret-rotation.png)
_Bearer token obtained, User.Read.All and Mail.Read permissions_

![Secret deleted from malicious exfil app](assets/images/2026-02-25-analyzing-the-midnight-blizzard-eviction-plan/malicious-exfil-app-no-secrets.png)
_Secret deleted from malicious exfil app_
...
![Post secret rotation my token still has User.Read.All permissions in the prod tenant](assets/images/2026-02-25-analyzing-the-midnight-blizzard-eviction-plan/token-post-secret-rotation.png)
_Post secret rotation my token still has User.Read.All permissions in the prod tenant_
...
![malicious-exfil-app Service Principal disabled in prod tenant](assets/images/2026-02-25-analyzing-the-midnight-blizzard-eviction-plan/malicious-exfil-app-prod-sp-disabled.png)
_malicious-exfil-app Service Principal disabled in prod tenant_

![Exfil attempt fails](assets/images/2026-02-25-analyzing-the-midnight-blizzard-eviction-plan/malicious-exfil-app-prod-sp-disabled-token-revoked.png)
_Exfil attempt fails_
